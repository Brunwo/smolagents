...
def get_tool_code_new(repo_id, token, **kwargs):
    # New implementation
...
def get_tool_code_old(repo_id, token, **kwargs):
    # Old implementation
    hub_kwargs_names = [
        "cache_dir",
        "force_download",
...
get_tool_code = get_tool_code_new

def install_dependencies(repo_id, token, **kwargs):
    hub_kwargs_names = [
        "cache_dir",
        "force_download",
        "resume_download",
...
# Call this function if you want to install dependencies
# install_dependencies(repo_id, token, **kwargs)
...
def from_hub(
    ...
    **kwargs,
    ...
    # Use the new or old implementation
    tool_code = get_tool_code(repo_id, token, **kwargs)
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        tool_class = find_tool_class(module)
